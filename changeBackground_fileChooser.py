...
def show_intro_instructions():
    ...
    welcome_txt = "Hello there! This program will let you use a colored background as a 'green screen'. You will need" \
                  " to select 3 things:\n\n1. Image of only the colored background.\n2. Image of yourself in a different background." \
                  "\n3. Image of the new background you want.\n\nYou must choose the images in that specific order.\n\n" \
                  "Let's begin!"
    easygui.msgbox(welcome_txt, title="Project Introduction")

    # First instruction
    first_img_instructions = "In the following file chooser you will pick the image of only the colored background..."
    easygui.msgbox(first_img_instructions, title="Background only", ok_button="Continue")

    # Choose first image
    root = tk.Tk()
    root.withdraw()
    background_route = filedialog.askopenfilename()

    # Second instruction
    second_img_instructions = "In the following file chooser you will pick the image of yourself in a different background (from the previous one)..."
    easygui.msgbox(second_img_instructions, title="Person in different background", ok_button="Continue")

    # Choose second image
    root = tk.Tk()
    root.withdraw()
    person_route = filedialog.askopenfilename()
